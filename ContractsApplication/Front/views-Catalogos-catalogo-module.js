...
/* harmony import */ var _pipe_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../pipe.module */ "K95I");
/* harmony import */ var _catalogo_routing_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./catalogo-routing.module */ "mdUE");
/* harmony import */ var _contract_register_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./contract-register.component */ "NPdu");
/* harmony import */ var _contracts_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./contracts.component */ "EDVH");
...
CatalogoModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _catalogo_routing_module__WEBPACK_IMPORTED_MODULE_11__["CatalogoRoutingModule"],
            _pipe_module__WEBPACK_IMPORTED_MODULE_10__["ApplicationPipeModule"],
        ...
        declarations: [
            _contracts_component__WEBPACK_IMPORTED_MODULE_13__["ContractsComponent"],
            _contract_register_component__WEBPACK_IMPORTED_MODULE_12__["ContractRegisterComponent"]
        ],
        exports: [],
        providers: [
...
let commonService = class commonService {
    ...
    onSaveContract(obj) {
        return this.http.post(this.urlContracts + (obj.Id === 0 ? '/SaveContract' : '/UpdateContract'), obj);
    }
};
...
/***/ "EDVH":
/*!********************************************************!*\
  !*** ./src/app/views/Catalogos/contracts.component.ts ***!
  \********************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_contracts_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./contracts.component.html */ "LvAU");
...
let ContractsComponent = class ContractsComponent {
    constructor(_router, _route, _commonService) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _Pipe_Cycle_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Pipe/Cycle.pipe */ "g4K4");
/* harmony import */ var _Pipe_onlyNumber_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Pipe/onlyNumber.directive */ "pO/D");




let ApplicationPipeModule = class ApplicationPipeModule {
};
ApplicationPipeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [],
        declarations: [
            _Pipe_Cycle_pipe__WEBPACK_IMPORTED_MODULE_2__["CyclePipe"],
            _Pipe_onlyNumber_directive__WEBPACK_IMPORTED_MODULE_3__["OnlyNumbersDirective"]
        ],
        exports: [
            _Pipe_Cycle_pipe__WEBPACK_IMPORTED_MODULE_2__["CyclePipe"],
            _Pipe_onlyNumber_directive__WEBPACK_IMPORTED_MODULE_3__["OnlyNumbersDirective"]
...
/***/ "LvAU":
/*!************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/Catalogos/contracts.component.html ***!
  \************************************************************************************************/
...
let ContractRegisterComponent = class ContractRegisterComponent {
    constructor(_router, _route, _commonService, _notification) {
        this._router = _router;
        this._route = _route;
        this._commonService = _commonService;
...
/***/ "g4K4":
/*!************************************!*\
  !*** ./src/app/Pipe/Cycle.pipe.ts ***!
  \************************************/
/*! exports provided: CyclePipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CyclePipe", function() { return CyclePipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");


let CyclePipe = class CyclePipe {
    constructor() {
        this.getFormat = (dateFormat) => {
...
CyclePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _contract_register_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contract-register.component */ "NPdu");
...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: _contract_register_component__WEBPACK_IMPORTED_MODULE_3__["ContractRegisterComponent"],
                data: {
...
/***/ "pO/D":
/*!**********************************************!*\
  !*** ./src/app/Pipe/onlyNumber.directive.ts ***!
  \**********************************************/
...
let OnlyNumbersDirective = class OnlyNumbersDirective {
    constructor(el) {
        ...
        this.specialKeys = [46, 9, 27, 13, 190, 35, 36, 37, 39];
        // Backspace, tab, end, home
        this.maxlength = 14;
        this.min = 1;
        this.max = 100000000;
        this.aceptDecimal = false;
    }
    ngOnInit() {
...
OnlyNumbersDirective.propDecorators = {
    ...
    aceptDecimal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
    onKeyDown: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['keydown', ['$event'],] }]
};
OnlyNumbersDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
